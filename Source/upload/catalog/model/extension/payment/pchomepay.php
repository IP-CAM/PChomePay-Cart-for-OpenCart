...
class ModelExtensionPaymentPChomePay extends Model
{
    ...
    public function getMethod($address, $total)
    {
        ...
        if ($status) {
            $method_data = array(
                ...
                'terms' => '',
                'sort_order' => $this->config->get($this->name_prefix . '_sort_order')
            );
        }
    ...
    {
        $sandBox_mode = $this->config->get($this->name_prefix . '_test');
        $baseURL = $sandBox_mode ? ModelExtensionPaymentPChomePay::SB_BASE_URL : ModelExtensionPaymentPChomePay::BASE_URL;
    ...
    public function getToken()
    {
        ...
        $appID = $this->config->get($this->name_prefix . '_appid');
        $secret = $sandBox_mode ? $this->config->get($this->name_prefix . '_sandbox_secret') : $this->config->get($this->name_prefix . '_secret');
